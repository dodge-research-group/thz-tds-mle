function varargout = figetfefit(varargin)
%FIGETFEFIT plots ECDF and representative residuals for ETFE fits
%
%   Fig = FIGETFEFIT returns figure handle
...
% ECDF
Ax(1) = subplot(1, 2, 1);
plotetfeecdf(Calc, Ax(1), 'index', idx);
Ax.XLim = [0 1000];
...
plotetfenormprob(Calc, Inset, 'index', idx);
...
plotresetfe(Calc, Ax(2), 'index', idx);
ylim(Ax(2), [-3.5 3.5])
set(Ax(2), 'YTick', (-3:3))
